...
continue_train = True
start_over = True
pretrained_model_path = '../output/train_exp113_20230601_210141/model_dump/snapshot_4.pth.tar'
...
trainset_3d = ['MSCOCO'] 
trainset_2d = []
trainset_humandata = ['BEDLAM', 'HumanSC3D', 'PROX', 'EgoBody_Kinect', 'SynBody_Magic1'] 
testset = 'EHF'
