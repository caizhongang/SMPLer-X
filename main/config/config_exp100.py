...
start_over = True
# pretrained_model_path = '../output/train_exp100_20230529_140147/model_dump/snapshot_2.pth.tar'
...
trainset_3d = ['MSCOCO', ]
trainset_2d = []
trainset_humandata = ['BEDLAM', 'PoseTrack', 'GTA_Human2', 'SynBody', 'SynBody_Magic1']
testset = 'EHF'
...
ARCTIC_train_sample_interval = 5
