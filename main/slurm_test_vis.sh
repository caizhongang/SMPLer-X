...
#     python test.py \
#         --num_gpus ${GPUS_PER_NODE} \
#         --exp_name output/test_${JOB_NAME}_ep${CKPT}_SHAPY \
#         --result_path ${RES_PATH} \
#         --ckpt_idx ${CKPT} \
#         --testset SHAPY \
...
#     python test.py \
#         --num_gpus ${GPUS_PER_NODE} \
#         --exp_name output/test_${JOB_NAME}_ep${CKPT}_RenBody_HiRes \
#         --result_path ${RES_PATH} \
#         --ckpt_idx ${CKPT} \
...
# #         --ckpt_idx ${CKPT} \
# #         --testset AGORA \
# #         --agora_benchmark test_only # agora-test with non-agora model; 'agora_model_test' for testing agora model
