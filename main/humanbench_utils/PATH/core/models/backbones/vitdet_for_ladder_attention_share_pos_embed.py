...
class ViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=80, embed_dim=768, depth=12,
        ...
        # task tokens for HPS estimation, ref: vit.py from osx/main/transformer_utils/mmpose/models/backbones/vit.py
    ...
    def forward_features(self, x, mask=None):
        ...
        return {'x': x, 'model_args': (B, Hp, Wp)}

    def forward(self, input_var):
        input_var = {'image': input_var}  # TODO: fix for our study
        ...
        # x = outs['mid_features'][-1]
        x = outs['x']
        B, Hp, Wp = outs['model_args']
